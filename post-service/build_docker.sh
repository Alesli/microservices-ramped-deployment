...
docker run -ti -e DB_URL='jdbc:postgresql://posts-db-container:5432/postsdb' -e DB_USER='root' -e DB_PASSWORD='password' -p 8089:8080 -d epamalesiaskarakhod/postapp-image-1.0.0